...
export class CmsSourceListComponent implements OnInit, OnChanges, OnDestroy {
    ...
    public sourceListCmsEvent: Subscription;
    ...
    constructor(
        ...
        public cmsSettingsService: CmsSettingsService,
    ...
    public ngOnChanges(changes: SimpleChanges): void {
        ...
        this.scroller.count = this.cmsSettingsService.userSettings?.pageSize || CMSConstants.DEFAULT_PAGE_SIZE;
     ...
     * @return {void}.
     */
    public updateSelection(source: Source): void {
        if (source.selected) {
     ...
     * @return {void}
     */
    public toggleSourceFavorite(source: Source): void {
        if (source.disabled) {
            return;
        }
