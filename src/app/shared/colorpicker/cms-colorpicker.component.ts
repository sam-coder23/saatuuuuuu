...
export class CmsColorPickerComponent implements OnInit{
    ...
    public  mInputColor: string = '';

    public  mDefaultColor: string = '';
     ...
     */
    public showColorPaletteBox(): void{
        ...
        if (isCurrentPickerOpened === "true") {
            this.renderer.setAttribute(currentElement, 'isopened', "false");
        } else{
           this.closeOpenedColorPickers();
           this.renderer.setAttribute(currentElement, 'isopened', "true");
        }
    }
     ...
     */
    public closeOpenedColorPickers(): void{
        ...
        for (var i = 0; i < colorPickers.length; i++) {
            ...
            if (isopened === "true") {
                this.renderer.setAttribute(colorPickers[i], 'isopened', "false");
            }
        }
    }
