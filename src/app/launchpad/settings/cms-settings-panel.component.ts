...
export class CmsSettingsPanelComponent implements OnInit {
    ...
    public autoLogOffTime: number;

    //hold no display information
    public noDisplayAvailable: boolean = false;

    //hold wall connection constant information
    public wallConnection: any = CMSConstants.WALL_CONNECTION;
     ...
     * @return void
     */
    public updateUserSettingsByAction(event: any): void {
     ...
     * @return void
     */
    public goToSelectDisplayForAutoConnect(): void {
     ...
     * @return void
     */
    public updateTransparency(): void {
     ...
     * @return void
     */
    public increaseTransparency(): void {
        const transparency: number = this.userSettings.sourceLabel.transparency;
     ...
     * @return void
     */
    public decreaseTransparency(): void {
        const transparency: number = this.userSettings.sourceLabel.transparency;
     ...
     * @return void
     */
    public showLanguages(event: any): void {
     ...
     * @return void
     */
    public increaseLogOffTime(): void {
        const autoLogOffTime: number = ParsingManager.TO_INTEGER(this.autoLogOffTime);
     ...
     * @return void
     */
    public decreaseLogOffTime(): void {
        const autoLogOffTime: number = ParsingManager.TO_INTEGER(this.autoLogOffTime);
