...
describe("CmsCardComponent", () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            ...
            regEx = /&_=\d{10,14}/g;
            localHostRegEx = /localhost:3001/g;
        });
    }));
    ...
    it("Should not convert IPToHost when snapshot path has not an IP addresss", () => {
        const snapshotPath: string = "localhost:3001/display_snapshot.jpg";
    ...
    it("Should be set refreshsnapshot and isFavorite on ngOnChanges event", () => {
        ...
        component2.ngOnChanges({
            favorite: new SimpleChange(undefined, component2.card.favorite, false)
        });
