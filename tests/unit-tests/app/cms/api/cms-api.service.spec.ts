...
// import { BaseRequestOptions, HttpClient, HttpClientModule, Response, ResponseOptions } from "@angular/common/http";
...
//                     ],
//                     provide: HttpClient,
//                     useFactory: (mockBackend: MockBackend, defaultOptions: BaseRequestOptions): HttpClient => {
...
//     beforeEach(inject([HttpClient, Router, APIRequest, StorageManager, AppConfig, MockBackend], (http: HttpClient, routerService: Router, apiRequestService: APIRequest, storageManagerService: StorageManager, appConfigService: AppConfig, mockBackEndService: MockBackend) => {
