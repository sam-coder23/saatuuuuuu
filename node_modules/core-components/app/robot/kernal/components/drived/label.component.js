...
var LabelComponent = /** @class */ (function (_super) {
    ...
    LabelComponent = LabelComponent_1 = __decorate([
        core_1.Component({
            selector: "nd-label",
            template: "\n        <div class=\"nd-form-control nd-label\" *ngIf=\"Model\" [hidden]=\"Model.hidden\" [ngClass]=\"Model.class\">\n            <div class=\"key\">\n                {{Model.label}}\n            </div>\n            <div class=\"value\">\n                {{Model.data[Model.key]}}\n            </div>\n        </div>\n    ",
            styles: [
                "\n            .nd-form-control {\n                display: flex;\n            }\n            .value {\n                margin: 10px 0;\n            }\n        "
            ],
            providers: [
                {
                    ...
                    useExisting: core_1.forwardRef(function () { return LabelComponent_1; }),
                    multi: true
                }
            ]
        })
