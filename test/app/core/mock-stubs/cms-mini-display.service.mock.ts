...
/**
 *  mockDisplay1 and expectedMiniDisplayResponse1 data is for the use case,
 *  when display width is less than height
 */
let mockDisplay1 = {
    "type": "DisplayWall",
    "id": 31,
...
let expectedMiniDisplayResponse1 = {
    displaySize: {
        "height": 1200,
        "width": 1920
    },
    ...
    miniDisplayContentList: [
        new TileContent({
            ...
            "snapshotPath": "https://10.98.0.231//mediaconfiguration?action=get&path=images%2Fsnapshots%2Fperspectives%2F145.jpeg",
            "zOrder": 1,
            "absoluteSize": new Tile({ "width": 960, "height": 1200, "left": 960, "top": 0 }),
        ...
        new TileContent({
            ...
            "snapshotPath": "https://10.98.0.231//mediaconfiguration?action=get&path=images%2Fsnapshots%2Fperspectives%2F86.jpeg",
            "zOrder": 2,
            "absoluteSize": new Tile({ "width": 960, "height": 1200, "left": 0, "top": 0 }),
            "lastModified": Date.now().toString()
        })
    ],
    displayTilerList: [
        new Tile({ "left": 0, "top": 0, "width": 960, "height": 1200 }),
        new Tile({ "left": 960, "top": 0, "width": 960, "height": 1200 })
    ],
    miniDisplaySize: {
        "height": 471,
        "width": 753.6
...
let expectedMiniDisplayResponse2 = {
    displaySize: {
        "height": 2280,
        "width": 7680
    },
    ...
    miniDisplayContentList: [
        new TileContent({
            ...
            "resourceId": 8,
            "lastModified": Date.now().toString(),
            "absoluteSize": { "width": 3840, "height": 2280, "left": 3840, "top": 0 }
        }),
        new TileContent({
            "id": 352,
            "name": "Airport Entrance",
            ...
            "resourceId": 86,
            "lastModified": Date.now().toString(),
            "absoluteSize": { "width": 3840, "height": 2280, "left": 0, "top": 0 }
        })
    ],
    displayTilerList: [
        new Tile({
